    ...
    <>
      <div className="bg-white w-full rounded-lg p-6 shadow-md shadow-gray-500">
        ...
        <div className="bg-yellow-100 border-yellow-200 px-4 py-2 mb-3 rounded-lg">
          ...
          <p className="ml-8">
            Select all document types that your institution issues to applicants
            and can validate for employees or other stakeholders
          </p>
        </div>
          ...
          {isLoading ? (
            ...
            <form onSubmit={handleFormSubmit} className="text-sm">
              ...
              <div className="flex justify-end mt-4">
                <button
                  className="flex items-center bg-green-200 hover:bg-green-300 border border-green-700 text-green-700 px-4 py-1 rounded-md"
                  type="submit"
                >
                  <IoMdAdd size={20} className="mr-2" /> Add
                </button>
              </div>
            </form>
          )}
