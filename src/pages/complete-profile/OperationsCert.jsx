...
class OperationsCert extends Component {
  ...
  fetchInstitutionCertificate = async () => {
    try {
      ...
      if (certificateData) {
        ...
        }/storage/app/public/${certificateData.certificate_file}`;
      ...
      toast.error(
        error.response?.data?.message ||
          "Failed to fetch institution certificate"
      );
    }
  };
  ...
  handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "/institution/institution-certificates",
        formData
      );
  ...
  render() {
    const { selectedFile, previewImage, previewPDF, error, isSaving } =
      this.state;
          ...
          >
            ...
            <div className="w-full flex flex-col items-center">
              ...
              >
                ...
                {/* Image preview */}
                {previewImage && (
                  <div className="flex justify-center items-center w-full h-[500px] overflow-auto">
                    {" "}
