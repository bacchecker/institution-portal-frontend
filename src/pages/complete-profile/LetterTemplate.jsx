...
const LetterTemplate = forwardRef((props, ref) => {
  ...
  const fetchInstitution = async () => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message || "Failed to load institution data"
      );
    }
    setIsLoading(false);
  };
  ...
  return (
    <>
      <div className="bg-yellow-100 border-yellow-200 px-4 py-2 mb-3 rounded-lg">
        ...
        <p className="ml-8">
          Please note that the letter you are viewing is a template for all
          document verifications and validations that will be attached and
          addressed to users who seek such services.
        </p>
      </div>
          ...
          <div>
            ...
            <div className="mt-24 px-12 text-sm">
              ...
              <div className="mt-10">
                ...
                <p>
                  We are writing to inform you about the verification process
                  for the document(s) submitted for validation on September
                  18th, 2024. After a thorough review, we have determined the
                  following regarding the submitted document(s):
                </p>
              </div>
              <div className="mt-4 space-y-2">
                <p className="font-semibold">
                  Document Title/Reference: Degree Certificate
                </p>
                <div className="flex justify-between items-center">
                  <p className="flex-1">
                    1. Does the degree certificate have the official seal of the
                    institution?
                  </p>
                  <FaCheck size={18} />
                </div>
                <div className="flex justify-between items-center">
                  <p className="flex-1">
                    2. Is the degree certificate issued by an accredited
                    institution?
                  </p>
                  <FaCheck size={18} />
                </div>
                <div className="flex justify-between items-center">
                  <p className="flex-1">
                    3. Is the name on the degree certificate consistent with the
                ...
                <div className="flex justify-between items-center">
                  <p className="flex-1">
                    4. Does the date of graduation match the institution's
                    records?
                  </p>
                  <FaCheck size={18} />
                </div>
                <div className="flex justify-between items-center">
                  <p className="flex-1">
                    5. Are there any alterations or signs of tampering on the
                    document?
                  </p>
                  <FaCheck size={18} />
                </div>
              ...
              <div className="mt-4">
                ...
                <p>
                  Based on the responses above, we have determined that while
                  the majority of the document verification questions returned
                  true, there are some inconsistencies that require further
                  investigation.
                </p>
                <p className="mt-2">
                  If you require further clarification regarding this, please do
                  not hesitate to contact us at {formData.institution_email}.
                </p>
              </div>
