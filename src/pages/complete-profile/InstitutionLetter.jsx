...
class InstitutionLetter extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.editorRef.current && this.editorRef.current.editor) {
      if (
        prevState.validation_approved_content !==
        this.state.validation_approved_content
      ) {
        this.editorRef.current.editor.setContents(
          this.state.validation_approved_content
        );
      }

      if (
        prevState.validation_declined_content !==
        this.state.validation_declined_content
      ) {
        this.editorRef.current.editor.setContents(
          this.state.validation_declined_content
        );
      ...
      if (
        prevState.verification_approved_content !==
        this.state.verification_approved_content
      ) {
        this.editorRef.current.editor.setContents(
          this.state.verification_approved_content
        );
      ...
      if (
        prevState.verification_declined_content !==
        this.state.verification_declined_content
      ) {
        this.editorRef.current.editor.setContents(
          this.state.verification_declined_content
        );
  ...
  fetchInstitutionLetters = async () => {
    try {
      ...
      if (letterContent.validation_approved_content != null) {
        this.setState({
          validation_approved_content:
            letterContent.validation_approved_content,
        });
      }
      ...
      if (letterContent.validation_declined_content != null) {
        this.setState({
          validation_declined_content:
            letterContent.validation_declined_content,
        });
      }
      ...
      if (letterContent.verification_approved_content != null) {
        this.setState({
          verification_approved_content:
            letterContent.verification_approved_content,
        });
      }
      ...
      if (letterContent.verification_declined_content != null) {
        this.setState({
          verification_declined_content:
            letterContent.verification_declined_content,
        });
      }
    } catch (error) {
      toast.error(
        error.response?.data?.message || "Failed to fetch institution letters"
      );
    }
  };
  ...
  handleSaveTemplate = async () => {
    ...
    try {
      const response = await axios.post(
        "/institution/institution-letters",
        formData
      );
  ...
  render() {
    ...
    return (
      <AuthLayout title="Letter Templates">
        <div className="p-3">
              ...
              {activeTab === "validation_letters" && (
                <div className="flex border-b border-gray-300">
                  <button
                    ...
                    onClick={() =>
                      this.switchSubTab("validation_approved_letter")
                    }
                  >
                    Approval Letter
                  </button>
                  <button
                    ...
                    onClick={() =>
                      this.switchSubTab("validation_declined_letter")
                    }
                  >
                    Declined Letter
                  </button>
              ...
              {activeTab === "verification_letters" && (
                <div className="flex border-b border-gray-300">
                  <button
                    ...
                    onClick={() =>
                      this.switchSubTab("verification_approved_letter")
                    }
                  >
                    Approval Letter
                  </button>
                  <button
                    ...
                    onClick={() =>
                      this.switchSubTab("verification_declined_letter")
                    }
                  >
                    Declined Letter
                  </button>
