    ...
    render() { 
        return ( 
            ...
            <div className="w-full">
                ...
                <div className="">
                    <p className='font-bold text-gray-800 text-xl mb-2 mt-6'>Overview</p>
                    <div className="grid grid-cols-2 xl:grid-cols-4 gap-8">
                        ...
                        <div className="col-span-2 xl:col-span-1 flex flex-col justify-center bg-white xl:-mt-12 p-6">
                            ...
                            <img 
                                src={`${import.meta.env.VITE_BASE_URL}/storage/${this.state.logo}`} 
                            ...
                            <MdOutlineVerifiedUser className='text-green-600 self-center mt-1' size={18}/>
                            <div className="text-center font-bold mt-2">
                                <div className="flex space-x-2 justify-center">
                                    <p className='text-gray-800'>{this.state.name}</p>
                                    
                                </div>
                                <p className='text-gray-600 text-sm my-3'>({this.state.prefix})</p>
                                
                                <p className='text-xs font-light text-gray-800'>{this.state.description}</p>
                            </div>
                        </div>
                    </div>
                    <div className="grid grid-cols-2 xl:grid-cols-4 gap-8">
                        <div className="col-span-3 border p-4 rounded-md mt-6 bg-white">
                            ...
                            <div className="grid grid-cols-7 gap-4 border rounded-lg p-4">
                                <div className="flex items-center justify-center bg-blue-200 rounded-full w-12 h-12"><IoDocumentAttach className='text-gray-900' size={20}/></div>
                                <div className="col-span-3">
                                    <p className='font-medium'>Fredrick Nyarkoh</p>
                                    <p className='text-sm text-gray-700 font-medium'>Academic Transcript</p>
                                </div>
                                <div className="col-span-2">
                                    <p className='text-xs font-semibold text-gray-600'>Date Applied</p>
                                    <p className='text-sm font-semibold text-yellow-600'>Thu 21 Apr, 2022</p>
                                </div>
                                <button className="border rounded-md text-xs font-medium text-gray-700 h-8 self-center hover:bg-blue-200">View Request</button>
                            </div>
                        </div>
