            ...
            <div className="bg-white p-6 rounded shadow-lg w-2/3 lg:w-1/2 xl:w-1/3">
              ...
              <div className="flex items-center justify-center mb-4">
                <svg
                  ...
                  fill="currentColor"
                  className="bi bi-exclamation-triangle-fill w-12 h-12 text-red-600"
                  viewBox="0 0 16 16"
                >
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xs">
                    This action will end your session, and you will need to log
              ...
              <div className="flex justify-end space-x-2">
                <button
                  ...
                  className="py-2 px-4 border border-gray-400 text-gray-500 uppercase text-xs"
                >
                  Cancel
                </button>
                <button
                  onClick={this.handleSubmit}
                  className="py-2 px-4 bg-red-600 text-white uppercase text-xs"
                >
                  Logout
                </button>
              </div>
