...
function DashboardValidationRequestReports() {
  const statuses = [
    { title: "All", value: "" },
  ...
  const {
    data: institutionValidationRequestReports,
    isLoading,
    isFetching,
  } = useGetInstitutionValidationReportsQuery({
    page: pageNumber,
  ...
  return (
    <>
      <div className="bg-[#f8f8f8] p-[1vw] my-[1vw] rounded-[0.2vw]">
        ...
        >
          <h4 className="md:text-[1.1vw] font-[600] text-[3.5vw]">Recent Validation Request Report</h4>
          ...
          <table className="md:w-full w-[230vw] border-collapse md:text-[0.9vw] text-[3.5vw] relative">
            ...
            <tbody className="">
              {!isFetching && !isLoading ? (
                <>
                  {institutionValidationRequestReports?.validationPayments?.data
                    ?.length === 0 ? (
                    <tr>
                    ...
                    <>
                      {institutionValidationRequestReports?.validationPayments?.data?.map(
                        (payment, i) => {
                          return (
                            <tr key={i}>
...
export default DashboardValidationRequestReports;
