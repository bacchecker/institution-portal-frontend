...
function DashboardSupportTickets() {
    ...
    return (
        <>
            <div className="flex justify-between flex-direct-sm p-[1vw]">
                <div className="flex justify-between items-center content md:gap-[1vw] gap-[5vw]">
                    <h4 className="font-[600] md:text-[1.2vw] text-[3.5vw]">Recent Tickets</h4>
                ...
                <div className="flex items-center md:gap-[1vw] gap-[5vw] mt-[4vw] md:mt-0">
                    <h4 className="md:text-[1vw] text-[3.5vw]">Filter By Status</h4>
                    <SelectInput
            ...
            <div className="w-full bg-[#f8f8f8] p-[1vw] md:min-h-[40vw] min-h-[100vw] gap-[3vw] overflow-auto  table-cover md:mt-[1vw] mt-[6vw] scroll-width">
                            ...
                            <th className="md:py-[1vw] py-[3vw] md:px-[1vw] px-[3vw] border-b w-[13%]">
                                ...
                                >
                                    <div className="flex flex-col items-center justify-center md:gap-[0.1vw] gap-[0.3vw]">
                                        ...
                                        ></i>
                                        <i
                                            className={`bx bxs-down-arrow text-[0.6vw] ${(!sortOrder || sortOrder === "asc") && sortBy === "type"
                                                ? "text-[#ffffff]"
                                                : ""
                                                }`}
                                        ></i>
                        ...
                        {!isFetching && !isLoading ? (
                            ...
                            {moment(ticket?.created_at).format("ll")}
                                                    ...
                                                    <td className="md:py-[1vw] py-[3vw] md:px-[2.5vw] px-[6vw] border-b w-[15%]">
                                                        <div
                                                            className={`md:py-[0.3vw] py-[0.5vw] md:px-[1vw] px-[3vw] w-[fit-content] border ${ticket?.status?.toLowerCase() === "open"
                                                        ...
                                                        >
                                                            <h4
                                                                className={`md:text-[0.9vw] text-[3vw] ${ticket?.status?.toLowerCase() === "open"
                                                                    ? "text-[#000]"
                                                                    : ticket?.status?.toLowerCase() === "closed"
                                                                        ? "text-[#00612D]"
                                                                        : "text-[#FFA52D]"
