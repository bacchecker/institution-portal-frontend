...
class AddDocumentType extends Component {
    constructor(props) {
        ...
        this.handleSearchAvailableNameChange = this.handleSearchAvailableNameChange.bind(this);
        this.handleSearchInstitutionNameChange = this.handleSearchInstitutionNameChange.bind(this);
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevState.searchAvailableName !== searchAvailableName || prevState.searchInstitutionName !== searchInstitutionName) {
            this.fetchDocumentTypes();
        }
    }
    ...
    async fetchDocumentTypes() {
        ...
        try {
            ...
            this.setState({
                availableDocumentTypes: response.data.available_document_types,
                institutionDocumentTypes: response.data.institution_document_types,
                isLoading: false
            });
        } catch (error) {
    ...
    handleCheckboxChange(id) {
        this.setState((prevState) => {
            ...
            if (selectedDocumentTypes.includes(id)) {
                return {
                    selectedDocumentTypes: selectedDocumentTypes.filter(item => item !== id)
                };
            } else {
                return {
            ...
            <>
                ...
                <div className="bg-white w-full rounded-lg p-6 shadow-md shadow-gray-500">
                    ...
                    <div className="bg-yellow-100 border-yellow-200 px-4 py-2 mb-3 rounded-lg">
                        ...
                        <p className='ml-8'>Select fred all document types that your institution issues to applicants and can validate for employees or other stakeholders</p>
                    </div>
                        ...
                        {isLoading ? (
                            ...
                            <form onSubmit={this.handleFormSubmit} className="text-sm">
                                ...
                                <div className="flex justify-end mt-4">
                                    <button
                                        className={`flex items-center ${isSaving ? 'bg-gray-300 text-gray-500' : 'bg-green-200 text-green-700 hover:bg-green-300'} border border-green-700 px-4 py-1 rounded-md`}
                                        type='submit'
                                        disabled={isSaving}
                                    >
                                        {isSaving ? (
