...
export default function Dashboard() {
        ...
        <div className="w-full flex flex-col justify-center h-full">
            ...
            <button type="button" onClick={() => {
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                    ...
                    {/* Step 2 */}
                    <li>
                    <span className="font-medium text-black">Document Owner Notification</span>
                    <ul className="list-disc list-inside pl-5 mt-1 space-y-1 text-gray-600">
    ...
    const handleFormSubmit = async (e) => {
        ...
        ...(selectedPayment === "card" && { payment_method: cardType, "VISA": paymentDetails.cardNumber }),
        ...(selectedPayment === "mobile_money" && { payment_method: paymentDetails.mobileNetwork, payment_detail: paymentDetails.mobileNumber }),
        };
    ...
    <div className="bg-white text-sm w-full">
            ...
            <div className="h-full flex flex-col relative">
                ...
                <div className="w-full mx-auto p-2 rounded-md flex-1 overflow-y-auto">
                    <div className="w-full rounded-lg overflow-hidden flex justify-center items-center">
                        {/* Content */}
                        <div className="w-full font-semibold text-gray-700">{pages[currentPage-1]}</div>
                    </div>
                </div>
        ...
        >
            ...
            <div className="flex flex-col font-semibold py-2">
                ...
                <div className="">
                    <p className="font-semibold text-black text-base">Add a billing method</p>
