...
class InstitutionUsers extends Component {
  ...
  fetchInstitutionsUsers = async (page = 1) => {
    ...
    const response = await axios
      .get(`/institution/institution-teams/${institutionId}`, {
        params: {
          page,
          search,
        },
          ...
          <div className="mb-4 flex space-x-4">
            <div className="relative w-full lg:w-2/3">
              ...
              <input
                ...
                placeholder="Search by Employee name, phone number, email or role"
                required
              />
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4">
            <div className="">
              ...
              <table className="min-w-full bg-white text-black text-sm">
                <thead className="bg-gray-100 rounded-lg top-0 z-10">
                  {" "}
                              ...
                              <div className="absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded shadow-lg z-50">
                                <ul className="py-1 text-sm">
                                  ...
                                  <li
                                    ...
                                    onClick={() =>
                                      this.handleSuspendAccountClick(request)
                                    }
                                  >
                                    Suspend Account
                                  </li>
          ...
          {createModal && (
            <div className="fixed z-50 inset-0 bg-black bg-opacity-60 flex justify-end">
              <form
                ...
                className="w-1/2 lg:w-1/3 xl:w-[30%] h-full bg-white shadow-lg transition-transform duration-700 ease-in-out transform"
                style={{
                  right: 0,
                  position: "absolute",
  ...
  handleEditProfile = async (e, staffId) => {
    ...
    try {
      const response = await axios.post(
        `/institution/update-profile/${staffId}`,
        formData
      );
  ...
  render() {
    ...
    return (
      <>
        <div className="fixed z-50 inset-0 bg-black bg-opacity-60 flex justify-end">
          <form
            onSubmit={(e) => this.handleEditProfile(e, staffId)}
            className="w-1/2 lg:w-1/3 xl:w-[30%] h-full bg-white shadow-lg transition-transform duration-700 ease-in-out transform"
            style={{
              right: 0,
              position: "absolute",
    ...
    return (
      <>
        <div className="fixed z-50 backdrop-blur-sm bg-black inset-0 overflow-y-auto bg-opacity-60">
          <form
            onSubmit={(e) => this.handleDeleteQuestion(e, staffId)}
          ...
          >
            <div className="w-full lg:w-1/2 h-44 relative bg-white shadow-lg">
              <div className="flex justify-between bg-deepBlue text-white">
                <h2 className="text-xl font-medium py-2 px-4 uppercase">
                  Reset Password
                </h2>
              ...
              <div className="w-full text-left font-medium text-sm my-6 mx-4">
  ...
  render() {
    ...
    return (
      <>
        <div className="fixed z-50 backdrop-blur-sm bg-black inset-0 overflow-y-auto bg-opacity-60">
          <form
            onSubmit={(e) => this.handleSuspendAccount(e, staffId)}
            className="flex items-center justify-center min-h-screen"
          >
            <div className="w-full lg:w-1/2 h-44 relative bg-white shadow-lg">
              ...
              <div className="w-full text-left font-medium text-sm my-6 mx-4">
                Are you sure you want to suspend this users account?{" "}
              </div>
              ...
              <div className="flex absolute bottom-4 right-4 justify-end gap-x-2">
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center  ${
                    ...
                    isSuspending ? "cursor-not-allowed" : ""
                  }`}
                >
                  {isSuspending ? (
                    <>
