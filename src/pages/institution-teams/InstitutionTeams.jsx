...
class InstitutionTeams extends Component {
  ...
  fetchInstitutionTeams = (page = 1) => {
    ...
    axios
      .get(`/institution/institution-teams`, {
        params: {
          page,
          search,
        },
  ...
  render() {
    const { institutionTeams, currentPage, lastPage, createModal, isSaving } =
      this.state;
    return (
      <AuthLayout title="Teams">
                  ...
                  {institutionTeams.map((request) => (
                    ...
                    >
                      <div className="flex items-center space-x-4 absolute left-0 bg-gradient-to-tl from-red-400 via-red-500 to-red-700 rounded-r-full text-white px-2 py-2 shadow-md shadow-gray-500">
                        ...
                        <div className="flex items-center justify-center w-10 h-10 bg-white text-red-800 rounded-full shadow-md shadow-gray-500">
                          <FaUsers size={20} />
                        </div>
                      </div>
                      <div className="ml-28 p-3">
                        ...
                        <div className="flex space-x-4 text-sm mt-2 italic text-gray-500">
                          <p className="w-2/3">
                            Click to add members for this team or department
                          </p>
                          <IoArrowForwardCircle
                            size={26}
                            className="self-end group-hover:text-red-800"
                          />
                        </div>
                      </div>
                    </NavLink>
