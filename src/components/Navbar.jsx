...
class Navbar extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className="text-gray-800 bg-white dark:bg-slate-900 px-4 py-[3px] flex justify-between items-center border-b font-figtree"
      ...
      >
        ...
        <div className="flex gap-5 items-center">
          ...
          {/* <Logout /> */}
          <div
            className="flex items-center gap-2 mr-2 hover:bg-blue-100 rounded-md px-2 py-1 cursor-pointer"
          ...
          >
            ...
            <div className="flex-1 text-sm">
              <p className="font-semibold">
                {userData.first_name} {userData.other_name} {userData.last_name}
              </p>
